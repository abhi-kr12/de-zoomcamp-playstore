...
6. **Install Anaconda on VM**
   - Download Anaconda package from [here](https://www.anaconda.com/download). The version is 64-Bit (x86) Installer. Copy the link of this version.
...
11. **Configure Mage**
    ...
    - We have two pipelines, 'api_to_gcs' and 'gcs_to_bigquery'.
        - **api_to_gcs:**
            ...
            - In the data exporter, we are pushing the dataframe to a Parquet file into the GCS bucket. The GCS bucket will be created after Terraform apply. Please copy the bucket name and paste it here.
        - **gcs_to_bigquery:**
